    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Development & Progress Updates"
          ...
          description="Once we agree on the plan, I dive into coding. From intial sketches to polished code, I keep you updated on every step of the way.">
        ...
        <Card title="Development & Launch"
          ...
          description="This is where the quality is brought through! Based on the approved design, I'll translate everything into functional code, building your website from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 lg:h-[35rem] rounded-3xl"
    >
